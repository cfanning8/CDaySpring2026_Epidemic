...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Build Infectious pilot training table for claim-B pipeline.")
    ...
    parser.add_argument("--output-subdir", type=str, default="pilot_infectious")
